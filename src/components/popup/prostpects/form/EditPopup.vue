 ...
 */
const getEl =()=>{
  carService.getCar(props.id)
      .then((res:{data: any}) => {
    form.id =res.data.data.id
    form.model = res.data.data.model;
    form.brand = res.data.data.brand;
    form.fuel_type = res.data.data.fuel_type,
    form.rental_price_per_day = res.data.data.rental_price_per_day;
    form.mileage = res.data.data.mileage;
    form.numberplate = res.data.data.mileage;
    form.year_of_manufacture = res.data.data.year_of_manufacture;
    form.description = res.data.data.description;
    form.number_place = res.data.data.number_place;
    form.gearbox = res.data.data.gearbox;
    form.gps = res.data.data.gps;
    form.status = res.data.data.status
    form.picture1 = res.data.data.picture1
    form.picture2 = res.data.data.picture2
    form.picture3 = res.data.data.picture3
    form.picture4 = res.data.data.picture4
    form.avatar1 = res.data.data.picture1
    form.avatar2 = res.data.data.picture2
    form.avatar3 = res.data.data.picture3
    form.avatar4 = res.data.data.picture4
